...
function(hashsum)
	...
	foreach(entry ${_PARAM_UNPARSED_ARGUMENTS})
		foreach(algo ${_PARAM_ALGORITHM})
			...
			file(WRITE ${hashfile} "${fileHash}")
			if(NOT ${_PARAM_NO_FILENAME})
				file(APPEND ${hashfile} "  ${fileName}")
			endif()
			file(APPEND ${hashfile} "\n")
		endforeach()
	endforeach()
endfunction()
...
function(RUN)
	...
	if(REVIEW)
		if(NOT PATCHED AND DEFINED ENV{GITLAB_CI})
			...
			elseif(DEFINED ENV{REVIEWBOARD_REVIEW_ID})
				step(uv pip install rbtools python-hglib)
				step(rbt patch --write ${patch.diff} --server $ENV{REVIEWBOARD_SERVER} --diff-revision $ENV{REVIEWBOARD_DIFF_REVISION} $ENV{REVIEWBOARD_REVIEW_ID})
